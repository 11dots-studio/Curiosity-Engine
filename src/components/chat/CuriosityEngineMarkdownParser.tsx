...
import { CuriosityEngineWrite } from "./CuriosityEngineWrite";
import { CuriosityEngineRename } from "./CuriosityEngineRename";
import { CuriosityEngineDelete } from "./CuriosityEngineDelete";
import { CuriosityEngineAddDependency } from "./CuriosityEngineAddDependency";
import { CodeHighlight } from "./CodeHighlight";
import { useAtomValue } from "jotai";
import { isStreamingAtom } from "@/atoms/chatAtoms";
import { CustomTagState } from "./stateTypes";

interface CuriosityEngineMarkdownParserProps {
  content: string;
}
...
/**
 * Custom component to parse markdown content with CuriosityEngine-specific tags
 */
export const CuriosityEngineMarkdownParser: React.FC<CuriosityEngineMarkdownParserProps> = ({
  content,
}) => {
...
function preprocessUnclosedTags(content: string): {
  ...
  const customTagNames = [
    ...
    "curiosity-engine-rename",
    "curiosity-engine-delete",
...
function renderCustomTag(
  ...
  switch (tag) {
    case "curiosity-engine-write":
      return (
        <CuriosityEngineWrite
          node={{
            properties: {
    ...
    case "curiosity-engine-rename":
      return (
        <CuriosityEngineRename
          node={{
            properties: {
    ...
    case "curiosity-engine-delete":
      return (
        <CuriosityEngineDelete
          node={{
            properties: {
              path: attributes.path || "",
            },
    ...
    case "curiosity-engine-add-dependency":
      return (
        <CuriosityEngineAddDependency
          node={{
            properties: {
